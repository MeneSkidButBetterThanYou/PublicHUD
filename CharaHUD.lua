...
local plrGui = plr:WaitForChild("PlayerGui")
	...
	spawn(function()
		...
		ui.SettingsButton.Position = UDim2.new(0.162, 0,0.99, 0)
		ui.StaminaBar.BackgroundTransparency = 0.6
		ui.StaminaBar.Bar.BackgroundColor3 = Color3.fromRGB(255,102,102)
		ui.ManaBar.BackgroundTransparency = 0.6
		ui.ManaBar.Bar.BackgroundColor3 = Color3.fromRGB(255,102,102)
