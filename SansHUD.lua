...
local plrGui = plr:WaitForChild("PlayerGui")
	...
	spawn(function()
		...
		ui.SettingsButton.Position = UDim2.new(0.145, 0,0.99, 0)
		ui.StaminaBar.BackgroundTransparency = 0.6
		ui.StaminaBar.Bar.BackgroundColor3 = Color3.fromRGB(102,178,255)
		ui.ManaBar.BackgroundTransparency = 0.6
		ui.ManaBar.Bar.BackgroundColor3 = Color3.fromRGB(102,178,255)
		...
		local ci = plrGui:WaitForChild("SansIndicator")
