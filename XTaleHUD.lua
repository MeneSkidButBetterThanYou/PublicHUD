...
local plrGui = plr:WaitForChild("PlayerGui")
	...
	local ui = ui1:WaitForChild("Ui")
		...
		ui.SettingsButton.Position = UDim2.new(0.175, 0,0.99, 0)
		ui.StaminaBar.BackgroundTransparency = 0.6
		ui.StaminaBar.Bar.BackgroundColor3 = Color3.fromRGB(255,51,51)
		ui.ManaBar.BackgroundTransparency = 0.6
		ui.ManaBar.Bar.BackgroundColor3 = Color3.fromRGB(153,51,255)
